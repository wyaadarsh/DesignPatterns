# Creating Domain Specific language: Domain Specific Language (DSL).

#  The Interpreter pattern is
# used to offer a programming-like framework to advanced users and domain experts,
# but without exposing the complexities of a programming language

# There are two categories of DSLs: internal DSLs and external DSLs. While
